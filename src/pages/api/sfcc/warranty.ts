...
import postWarrantyData from "./utils/postWarrantyData";
...
export default async function handler(req : NextApiRequest, res : NextApiResponse) {
  ...
  const warrantyData = {
    ...
    "LastName__c": "Pham",
    "SuppliedEmail": email,
    "SuppliedPhone": "7813334040",
    "Address_1__c": "100 Portland St",
    "Address_2__c": null,
    "City__c": "Boston",
    "State__c": "MA",
    "PostalCode__c": "02114-2013",
    "Location__c": "1",
    "StyleNumber__c": "GT-2000â„¢ 8",
    "Size__c": "42",
    "Date_Of_Purchase__c": "2024-01-01",
    "Miles__c": "0",
    "Activity__c": "Other, ",
    "Subject": subject,
    "Origin": "Web",
    ...
    "Identify_Record_Type__c": "2",
    "Description": description,
    "SFCC_URL__c": "https://sfcc-us-dev-us.dev.asics.com/us/en-us/warranty-form/",
    "Brand__c": "asics",
  ...
  try {
    ...
    if(data.success) {
      ...
      const caseData : CaseData = await postWarrantyData(token, warrantyData);
      ...
      console.log("Warranty:Post Attachment Data", finalPayload);
