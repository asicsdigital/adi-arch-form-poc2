...
export type SingleTokenObject = (SingleTokenObjectCommonProperties & {
    type: 'boxShadow';
...
export type TokenType = 'color' | 'implicit' | 'borderRadius' | 'sizing' | 'spacing' | 'text' | 'typography' | 'opacity' | 'borderWidth' | 'boxShadow' | 'fontFamilies' | 'fontWeights' | 'lineHeights' | 'fontSizes' | 'letterSpacing' | 'paragraphSpacing' | 'textDecoration' | 'textCase';
